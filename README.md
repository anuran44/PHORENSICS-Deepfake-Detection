...
## ⚙️ Enterprise Architecture & Big Data Scaling

PHORENSICS is built for high-throughput, horizontal scaling using **Apache Spark**. 

*   **Distributed Engineering:** Partitions large image datasets into Spark RDDs for clustered computing, achieving a 4.2x faster throughput than sequential execution.
...
│   └── visualizations.py
├── utils/               # PySpark Java bindings and PDF reporting 
│   ├── config.py        
│   └── reporting.py     
...
### Prerequisites
* Python 3.8+
* Java 17+ (Required for Apache Spark cluster execution)
